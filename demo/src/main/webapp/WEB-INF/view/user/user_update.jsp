...
<body>
	<form action="/front/user/update" id="formSubmit" method="post">
	    <table class="table table-bordered">
		   ...
		   <tbody>
		         ...
		         <td>
		         	<input type="text" class="form-control" name="user.nickname" value="${user.nickname }" placeholder="请输入用户名">
				 </td>
		      </tr>
		      <tr>
		         ...
		         <td>
		         	...
		         	<c:choose>
		         		<c:when test="${user.pic!=null && user.pic!='' }">
		         			<img src="${ctx}/${user.pic}" alt="" width="400" height="300" id="imgUrl" />
		         		</c:when>
		         		<c:otherwise>
		       ...
		       <tr>
		         ...
		         <td>
		         	<textarea rows="" cols="" name="user.content"  id="kindEditor">${user.content }</textarea>
				 </td>
		      </tr>
		   </tbody>
		</table>
	  <div>
	      ...
	      <input type="hidden" value="${user.pic }" name="user.pic" id="pic"/>
